    ...
    if (loading) return (
        <div className="min-h-screen bg-white flex items-center justify-center">
            <div className="flex flex-col items-center gap-4">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.4em] italic">Verifying Product...</span>
            </div>
        </div>
    );
    ...
    if (error) return (
        <div className="min-h-screen flex items-center justify-center bg-white p-8">
            ...
            >
                ...
                <h2 className="text-4xl font-black italic uppercase tracking-tighter text-black mb-4">Invalid Product</h2>
                ...
                <div className="relative z-10">
                    <div className="flex justify-between items-start border-b-4 border-black pb-8 mb-12">
                        <div>
                            ...
                            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-gray-400 italic mt-4">VIEW PRODUCT AUTHENTICITY VIEW CERTIFICATE</p>
                        </div>
                    ...
                    <div className="space-y-10 mb-16">
                        <div className="space-y-4">
                            <p className="text-[9px] font-black uppercase tracking-[0.5em] text-primary italic">TRANSACTION ID</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <div className="space-y-2">
                                <p className="text-[9px] font-black uppercase tracking-[0.5em] text-gray-400 italic">PRODUCT NAME</p>
                                <p className="text-2xl font-black italic uppercase tracking-tighter">{record.title}</p>
                            </div>
                            <div className="space-y-2">
                                <p className="text-[9px] font-black uppercase tracking-[0.5em] text-gray-400 italic">SOLD BY</p>
                                <p className="text-2xl font-black italic uppercase tracking-tighter text-primary">{record.store_name}</p>
                            </div>
                            <div className="space-y-2">
                                <p className="text-[9px] font-black uppercase tracking-[0.5em] text-gray-400 italic">CATEGORY</p>
                                <p className="text-xl font-black italic uppercase tracking-tighter">{record.category}</p>
                            </div>
                            <div className="space-y-2">
                                <p className="text-[9px] font-black uppercase tracking-[0.5em] text-gray-400 italic">MANUFACTURE DATE</p>
                    ...
                    <div className="pt-8 border-t-2 border-dashed border-gray-200 flex flex-col items-center gap-8">
                        ...
                        <div className="flex flex-wrap justify-center gap-6">
                            ...
                            <Link to="/shop" className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-black hover:text-primary transition-colors underline underline-offset-8 italic">
                                <ShoppingBag size={14} strokeWidth={3} /> SHOP DIRECTORY
                            </Link>
                        </div>
                    </div>
                </div>
